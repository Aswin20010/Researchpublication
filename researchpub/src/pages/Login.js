      ...
      {loggedIn == 1 ? (
        ...
        <>
          {loggedIn == 2 ? (
            ...
            <div className="py-6">
              <div className="flex bg-white rounded-lg shadow-lg overflow-hidden mx-auto max-w-sm lg:max-w-4xl my-20">
                <Containers className="hidden lg:block lg:w-1/2 bg-cover">
                  <img src={SSN} alt="ssn" width={500} height={250} />
                </Containers>
                <div className="w-full p-8 lg:w-1/2">
                  ...
                  <div className="mt-4 flex items-center justify-between">
                    ...
                    <span className="border-b w-1/5 lNameg:w-1/4"></span>
                  </div>
                  <div className="mt-4">
